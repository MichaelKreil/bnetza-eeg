...
async function start() {
	...
	await convertData('EinheitenWind', '../data/wind.geojsonl', windKeyFilter);

	await convertData('EinheitenSolar','../data/solar.geojsonl', solarKeyFilter);
